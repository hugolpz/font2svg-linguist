...
const fonts = {
  ...
  "lishu2": {
    url: './fonts/HanWangLiSuMedium.ttf',
    comment: "trad only, http://www.wildboar.net/multilingual/asian/chinese/language/fonts/unicode/non-microsoft/non-microsoft.html"
  },
  "zhuyin": {
    url: './fonts/HanWangKaiMediumChuIn.ttf',
  ...
  "nonSerif": {
    url: './fonts/noto/NotoSerifCJKtc-Medium.otf',
    comment: ""
  },
  "nonSans": {
    url: './fonts/noto/NotoSansTC-Medium.otf',
    comment: ""
  },
  "cwtex": {
    url: './fonts/cwtex/cwTeXQKaiZH-Medium.ttf',
    comment: "traditional characters, no simplified, radicals to extract from others"
  },
  "xinshu": {
    url: './fonts/hyi1gf.ttf',
